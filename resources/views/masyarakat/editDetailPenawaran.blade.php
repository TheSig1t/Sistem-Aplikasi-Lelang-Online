              ...
              <div class="row mb-2">
                ...
                <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ url('masyarakat/home') }}">< Kembali</a></li>
                    </ol>
                </div>
              </div>
            </div>
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                          ...
                          <form action="{{ url('masyarakat/postEditPenawaran/'.$row->id_history) }}" method="post">
                          <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text">IDR</span>
                            </div>
                                @csrf
                                <input type="text" name="penawaran_harga" class="form-control" value="{{ old('penawaran_harga',@$row->penawaran_harga)}}"> 
