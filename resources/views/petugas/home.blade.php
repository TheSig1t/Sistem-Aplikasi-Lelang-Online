        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item menu-open">
                <a href="{{ url('petugas/home') }}" class="nav-link active">
              ...
              <li class="nav-item">
                <a href="{{ url('petugas/formTambahBarang') }}" class="nav-link">
                  <i class="nav-icon far fa-plus-square"></i>
                  <p>
                    Tambah data barang
                  </p>
              ...
              <li class="nav-item">
                <a href="{{ url('petugas/homeLelang') }}" class="nav-link">
                  <i class="nav-icon fas fa-th"></i>
                  <p>Lelang</p>
                </a>
              </li>
          <li class="nav-item">
            <a href="{{ url('petugas/formPemenang') }}" class="nav-link">
            ...
            <div class="card-body">
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ url('petugas/formDetailBarang/'.$row->id_barang) }}" ><button class="btn btn-primary btn-sm"><i class="fas fa-eye"></i>detail</button></a>
                    <a href="{{ url('petugas/formEditBarang/'.$row->id_barang) }}" ><button class="btn btn-warning btn-sm"><i class="fas fa-pencil-alt"></i>Edit</button></a>
                    <a href="{{ url('petugas/postDelete/'.$row->id_barang) }}" onclick="return confirm('Apakah anda yakin ingin menghapus barang {{ $row->nama_barang }}')"><button class="btn btn-danger btn-sm"><i class="fas fa-trash"></i>Hapus</button></a>
                  </td>
                </tr>
              </tbody>
              @endforeach
